// ASL Curriculum Dataset, Badges, & MediaPipe Gesture Recognition Engine for Hana AI Companion
...
export const ASL_BADGES = [
  {
    id: 'badge-first-sign',
    title: 'First Sign Mastered',
    description: 'Master your very first ASL sign with Hana!',
    icon: 'Sparkles',
    unlockedAt: 1
  },
  {
    ...
    description: 'Master 5 letters of the ASL alphabet.',
    icon: 'Type',
    unlockedAt: 5
  },
  {
    ...
    description: 'Master all 26 letters of the ASL alphabet!',
    icon: 'Award',
    unlockedAt: 26
  },
  {
    ...
    title: 'Number Whiz',
    description: 'Master ASL numbers 1 through 10.',
    icon: 'Hash',
    unlockedAt: 10
  },
  {
  ...
  },
  {
    id: 'badge-quiz-ace',
    title: 'Quiz Ace',
    description: 'Score 100% on Hana\'s ASL Knowledge Quiz.',
    icon: 'HelpCircle',
    type: 'quiz',
    target: 100
  }
...
const RAW_ASL_CURRICULUM = [
  // --- ALPHABET A - Z ---
  {
    ...
    sign: 'A',
    title: 'Letter A',
    meaning: 'The letter A in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'B',
    title: 'Letter B',
    meaning: 'The letter B in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'C',
    title: 'Letter C',
    meaning: 'The letter C in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'D',
    title: 'Letter D',
    meaning: 'The letter D in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'E',
    title: 'Letter E',
    meaning: 'The letter E in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'F',
    title: 'Letter F',
    meaning: 'The letter F in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'G',
    title: 'Letter G',
    meaning: 'The letter G in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'H',
    title: 'Letter H',
    meaning: 'The letter H in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'I',
    title: 'Letter I',
    meaning: 'The letter I in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'J',
    title: 'Letter J',
    meaning: 'The letter J in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'K',
    title: 'Letter K',
    meaning: 'The letter K in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'L',
    title: 'Letter L',
    meaning: 'The letter L in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'M',
    title: 'Letter M',
    meaning: 'The letter M in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'N',
    title: 'Letter N',
    meaning: 'The letter N in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'O',
    title: 'Letter O',
    meaning: 'The letter O in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'P',
    title: 'Letter P',
    meaning: 'The letter P in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'Q',
    title: 'Letter Q',
    meaning: 'The letter Q in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'R',
    title: 'Letter R',
    meaning: 'The letter R in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'S',
    title: 'Letter S',
    meaning: 'The letter S in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'T',
    title: 'Letter T',
    meaning: 'The letter T in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'U',
    title: 'Letter U',
    meaning: 'The letter U in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'V',
    title: 'Letter V',
    meaning: 'The letter V in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'W',
    title: 'Letter W',
    meaning: 'The letter W in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'X',
    title: 'Letter X',
    meaning: 'The letter X in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'Y',
    title: 'Letter Y',
    meaning: 'The letter Y in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: 'Z',
    title: 'Letter Z',
    meaning: 'The letter Z in ASL fingerspelling',
  ...
  },
  {
    ...
    sign: '3',
    title: 'Number 3',
    meaning: 'The number 3 in ASL',
    description: 'Extend thumb, index, and middle fingers with palm facing inward.',
    tips: 'Thumb, index, and middle extended in ASL number 3.',
  ...
  // --- GREETINGS & COURTESY ---
  {
    ...
    sign: 'HELLO',
    title: 'Hello',
    meaning: 'A friendly greeting in ASL',
  ...
  },
  {
    ...
    sign: 'THANK YOU',
    title: 'Thank You',
    meaning: 'Expressing gratitude in ASL',
  ...
  },
  {
    ...
    sign: 'YES',
    title: 'Yes',
    meaning: 'Affirmation sign in ASL',
  ...
  },
  {
    ...
    sign: 'GOOD MORNING',
    title: 'Good Morning',
    meaning: 'Morning greeting in ASL',
  ...
  {
    id: 'asl-nice-to-meet-you',
    category: 'greetings',
    sign: 'NICE TO MEET YOU',
    title: 'Nice to Meet You',
    meaning: 'Welcoming phrase in ASL',
  ...
  // --- PHRASES ---
  {
    ...
    category: 'phrases',
    sign: 'LEARN ASL',
    title: 'I am learning ASL',
    meaning: 'Expressing your learning goal in sign language',
    description: 'Lift knowledge from palm into forehead (LEARN) followed by fingerspelling A-S-L.',
  ...
  },
  {
    ...
    sign: 'MY NAME IS',
    title: 'My Name Is...',
    meaning: 'Introducing yourself in ASL',
  ...
  },
  {
    ...
    sign: 'HELP',
    title: 'Help',
    meaning: 'Asking for or offering assistance in ASL',
  ...
  },
  {
    ...
    sign: 'FRIEND',
    title: 'Friend',
    meaning: 'Friendship sign in ASL',
  ...
  },
  {
    ...
    sign: 'HOW ARE YOU',
    title: 'How Are You?',
    meaning: 'Asking how someone is doing in ASL',
...
export const ASL_CURRICULUM = RAW_ASL_CURRICULUM.map(item => ({
  ...item,
...
export const HANA_PERSONALITY = {
  name: 'Hana',
  role: 'AI Voice & ASL Companion',
  greeting: "Hi there! I'm Hana, your AI friend and sign-language learning companion! 🌸 I'm so excited to practice ASL with you today! Would you like to try the alphabet (A-Z), numbers (1-10), or greetings?",
  safetyNotice: "Remember: I'm a friendly AI tutor to help you build confidence in beginner ASL. I'm not Deaf or a certified interpreter, so I always encourage connecting with human Deaf educators for full fluency!",
  encouragements: [
